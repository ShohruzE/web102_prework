...
const numRaised = GAMES_JSON.reduce( (total, game) => {
...
const filteredUnfunded = GAMES_JSON.filter( (game) => {
    return game.pledged < game.goal;
});
const numUnfundedGames = filteredUnfunded.length;
// create a string that explains the number of unfunded games using the ternary operator
const displayString = `A total of $${numRaised.toLocaleString('en-US')} has been raised for ${numGames} games. Currently, 
...
descriptionUnfundedGames.innerHTML = displayString;
descriptionContainer.append(descriptionUnfundedGames);
/************************************************************************************
...
const firstGameCard = document.getElementById('first-game');

const firstGameElement = document.createElement('div');
firstGameElement.innerHTML = `${firstGame.name}`;
firstGameCard.append(firstGameElement);

// do the same for the runner up item
const secondGameCard = document.getElementById('second-game');

const secondGameElement = document.createElement('div');
secondGameElement.innerHTML = `${secondGame.name}`;
secondGameCard.append(secondGameElement);